...
func NewEnvironment(environment ADMEnvironment) *ADMEnvironment {
	res := environment
	res.objectType = "environment"
	returnFields := []string{"name", "description", "tags"}
...
func NewApplication(application ADMApplication) *ADMApplication {
	res := application
	res.objectType = "application"
	returnFields := []string{"name", "description", "tags"}
	res.returnFields = returnFields
	return &res
}
